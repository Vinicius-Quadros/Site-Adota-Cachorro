...
<body>
    ...
    //Criar query para recuperar usuarios
      $query_usuarios = "SELECT cod_pet, nome_pet FROM tbl_pet ORDER BY cod_pet";
    //Preparar Query
    ...
    echo "<form method='POST' action='PetEdit.php'>";

      //Ler os regitros retornando do BD
      while($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)){
          //var_dump($row_usuario); 
          extract($row_usuario);
          echo "<input type='checkbox' name='usuario[$cod_pet]' value='".$cod_pet."'>";
          echo " ID do Pet: $cod_pet <br>";
          echo "Nome: $nome_pet <br>";
          echo "<br>";
      }

      echo "<input type='submit' value='Editar' name='editPet' style='font-size: 40px; background-color: #007BFF; padding: 0.5%;color: aliceblue; border-radius: 20px;
      ...
      margin-top: 4%; margin-right:33%;'></a>";

    //Fim do Formulário
     echo "</form>";
     echo "<a href='PetSalva.html'><input type='button' value='Novo' style='font-size: 40px; background-color: #007BFF; padding: 0.5%;color: aliceblue; border-radius: 20px; float: right; margin-top:-20%; margin-right:-2%;'></a>";
     echo "</div>";
    ?>
