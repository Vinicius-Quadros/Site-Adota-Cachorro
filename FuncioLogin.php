...
if(isset($_POST['usu']) && isset($_POST['senha'])) {
  ...
  $sql_code = "SELECT id_usuario, senha_usuario FROM tbl_login WHERE id_usuario = '$usu'";
  $sql_code1 = "SELECT id_usuario, senha_usuario FROM tbl_login WHERE id_usuario = '$usu' and senha_usuario = '$senha'";
  ...
  if($sql_query->num_rows == 0) {
    $_SESSION['msg'] = "<p style='color: #f00;'>Usuário está incorreto!</p>";
      ...
      if($sql_query1->num_rows == 0) {
        ...
        javascript:window.location='telaprinfun.html';</script>";
        //header("Location: telaprinfun.html");
      }
  }
...
<body>
    ...
    <div class="corpo">
        <form action="" onsubmit="return fun();" name="form" method="POST">
            <label><h3>Usuário</h3></label> <br>
            <input type="text" name="usu" size="33" required><span></span><br> <br>
            <label><h3>Senha</h3></label> <br>
            <input type="password" name="senha" size="33" required> <span></span>  <br> <br>
