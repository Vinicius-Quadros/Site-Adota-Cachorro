...
<body>
    ...
    //Criar query para recuperar usuarios
      $query_usuarios = "SELECT cpf_adotante, nome_adotante, email_adotante FROM tbl_adotante ORDER BY cpf_adotante DESC";
    //Preparar Query
    ...
    echo "<form method='POST' action='AdotanteEdit.php'>";

      //Ler os regitros retornando do BD
      while($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)){
          //var_dump($row_usuario); 
          extract($row_usuario);
          echo "<input type='checkbox' name='usuario[$cpf_adotante]' value='".$cpf_adotante."'>";
          echo " CPF: $cpf_adotante <br>";
          echo "Nome: $nome_adotante <br>";
          echo "E-Mail: $email_adotante <br>";
          echo "<br>";
      }

      echo "<input type='submit' value='Editar' name='editUsuarios' style='font-size: 40px; background-color: #007BFF; padding: 0.5%;color: aliceblue; border-radius: 20px;
      margin-top: 4%; margin-left: 5%;'>";
